...
public class Test {
    ...
    public static void main(String[] args) {
        try {
            ...
            Method method3 = myClass.getMethod("sum", double.class, double.class);
            System.out.println(method3.invoke(myObj, 2, 4));
            ...
            MyAnnotations annotations1 = (MyAnnotations)annotations[0];
            System.out.println(annotations1.value1());
            System.out.println(annotations1.value2());
